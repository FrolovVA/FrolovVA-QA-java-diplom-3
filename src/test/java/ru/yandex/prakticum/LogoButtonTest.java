...
public class LogoButtonTest {
    ...
    public LogoButtonTest(int emailLoginLength, int passwordLength, int nameLength){
    ...
    @Step("Переход по кнопке в логотипе из окна регистрации")
    public void goToLogoPageFromReg(){
        checkRegistrationStellarBurgerPageOpen();
        registrationStellarBurgerPage.clickLogoStellarBurger();
    }

    @Step("Переход по кнопке в логотипе из окна первого этапа восстановления пароля")
    public void goToLogoPageFromFirstStageRecovery(){
        checkFirstStageRecoveryPasswordPageOpen();
        firstStageRecoveryPasswordPage.clickLogoStellarBurger();
    }

    @Step("Переход по кнопке в логотипе из окна второй стадии восстановления пароля")
    public void goToLogoPageFromSecondStageRecovery(){
        checkSecondStageRecoveryPasswordPageOpen();
        secondStageRecoveryPasswordPage.clickLogoStellarBurger();
    }

    @Step("Переход по кнопке в логотипе из окна ленты заказов")
    public void goToLogoPageFromOrderFeed(){
        checkOrderFeedStellarBurgerPageOpen();
        orderFeedStellarBurgerPage.clickLogoStellarBurger();
    }
    ...
    @Step("Переход по кнопке в логотипе из личного кабинета")
    public void goToLogoPageFromPersonalAccount(){
        checkPersonalAccountStellarBurgerPageOpen();
        personalAccountStellarBurgerPage.clickLogoStellarBurger();
    }

    @Step("Переход по кнопке в логотипе из главной страницы Stellar Burger")
    public void goToLogoFromMainStellarBurgerPage(){
        checkMainStellarBurgerPageOpen();
        mainStellarBurgersPage.clickLogoStellarBurger();
    }
    ...
    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на главной странице Stellar Burger ведет на главную страницу Stellar Burger")
    public void logoButtonMainPageShouldOpenMainPageTest(){
        goToLogoFromMainStellarBurgerPage();
        checkMainStellarBurgerPageOpen();
    }

    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице авторизации ведет на главную страницу Stellar Burger")
    public void logoButtonLoginPageShouldOpenMainPageTest(){
        clickOnLoginButton();
    ...
    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице регистрации ведет на главную страницу Stellar Burger")
    public void logoButtonRegistrationPageShouldOpenMainPageTest(){
        clickOnLoginButton();
    ...
    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице первого этапа восстановления пароля ведет на главную страницу Stellar Burger")
    public void logoButtonFirstStageRecoveryPageShouldOpenMainPageTest(){
        clickOnLoginButton();
        goToFirstStageRecoveryFromLoginPage();
        goToLogoPageFromFirstStageRecovery();
        checkMainStellarBurgerPageOpen();
    }

    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице второй стадии восстановления пароля ведет на главную страницу Stellar Burger")
    public void logoButtonSecondStageRecoveryPageShouldOpenMainPageTest(){
        clickOnLoginButton();
        goToFirstStageRecoveryFromLoginPage();
        goToSecondStageRecovery(email);
        goToLogoPageFromSecondStageRecovery();
        checkMainStellarBurgerPageOpen();
    }

    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице личного кабинета ведет на главную страницу Stellar Burger")
    public void logoButtonPersonalAccountPageShouldOpenMainPageTest(){
        creatingUser(email, password, name);
        clickOnLoginButton();
        fillAndLogin(email, password);
        goToPersonalAccount();
        goToLogoPageFromPersonalAccount();
        checkMainStellarBurgerPageOpen();
    }


    @Test
    @DisplayName("Проверка: нажатие на логотип Stellar Burger на странице ленты заказов ведет на главную страницу Stellar Burger")
    public void logoButtonOrderFeedPageShouldOpenMainPageTest(){
        goToOrderFeed();
        goToLogoPageFromOrderFeed();
        checkMainStellarBurgerPageOpen();
    }
